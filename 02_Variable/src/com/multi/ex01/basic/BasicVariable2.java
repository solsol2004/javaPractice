...
public class BasicVariable2 {
	...
	public static void main(String[] args) {
		...
		int intValue = 40000;
		long longValue = 142432423545243252L; // long 리터럴은 끝에 'l' 또는 'L'이 있어야함
		...
		// 2. 실수 : float(4), double(8)
		float  flatValue = 3.142358538f; //float 리터럴은 끝에 'f', 'F'가 있어야함
		double doubleValue = 3.142358538;
		...
		BigDecimal bigValue = new BigDecimal("3.23948928940890890890809908923804982309284902304");
		...
		// 결론: 부동소수점은 항상 오차 가능성이 존재함으로 자리수 제한에 염두 필요!
	
		String str = String.format("%.2f", testDouble);
		System.out.println(str);

		//3. 문자 : char(2)
		char charValue1 = 65; // ASCII 코드에 따라서 'A'가 뜸
		char charValue2 = 'A';
