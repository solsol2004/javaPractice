package com.multi.ex05.clone;

public class Clone {
	
	// 객체 단위로 hard copy하는 방법
	public static void main(String[] args) {
		User4 user1 = new User4("testID1", "김길동1", 21, 10000.123);
		User4 user2 = new User4("testID2", "김길동2", 22, 10000.123);
		
		// 1. 전통적인 방법 ★★★ -> 치명적인 단점은 멤버변수가 많아지면 사용 불가능..
		User4 user1copy = new User4();
		...
		User4 user2copy = null;
		try {
			user2copy = (User4) user2.clone();
		} catch (Exception e) {
			e.printStackTrace();
		}
